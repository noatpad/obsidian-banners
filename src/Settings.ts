    ...
    new Setting(containerEl)
      ...
      .addText((text) => {
        ...
        text.onChange(async (val) =>
          this.saveSettings({ height: val ? parseInt(val) : null })
        );
      });
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .onChange(async (val: StyleOption) =>
            this.saveSettings({ style: val }, { refreshViews: true })
          )
      );
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          ...
          .onChange(async (val) =>
            this.saveSettings(
              { showInInternalEmbed: val },
              { reloadSettings: true, refreshViews: true }
            )
          )
      );
    ...
    if (iconHorizontalAlignment === "custom") {
      settingHIA.addText((text) =>
        text
          ...
          .onChange(async (val) =>
            this.saveSettings(
              { iconHorizontalTransform: val || null },
              { refreshViews: true }
            )
          )
      );
    ...
    if (iconVerticalAlignment === "custom") {
      settingVIA.addText((text) =>
        text
          ...
          .onChange(async (val) =>
            this.saveSettings(
              { iconVerticalTransform: val || null },
              { refreshViews: true }
            )
          )
      );
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(useTwemoji)
          .onChange(async (val) =>
            this.saveSettings({ useTwemoji: val }, { refreshViews: true })
          )
      );
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .onChange(async (val) =>
            this.saveSettings({ bannersFolder: val || null })
          )
      );
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          ...
          .onChange(async (val) =>
            this.saveSettings({ allowMobileDrag: val }, { refreshViews: true })
          )
      );
  }
